   ...
   while True:
       ...
       if len(detection):
           ...
           if (time.time() - person_detect_start_time > duration_threshold):
                ...
                # Person is detected, save the image and send notifications.
                print("person here in the room")
                print("Hello! How can I help you today?")
                duration = input("How long do you want to record? (in seconds):")
                # Record audio for a specified duration.
                print("talk in 5 seconds for"+ duration + "seconds...")
